...
Insert into ref_vme (CD_VME,CD_META,INVENTORY_ID,NAME_E,NAME_F,NAME_S,NAME_A,NAME_C,NAME_R) 
values (10,172000,'VME_INV','Vme first factsheet',null,null,null,null,null); 


Insert into md_refobject (ID,NAME_E,NAME_F,NAME_S,PARENT,ANCESTOR,ISMAJOR,DOC,OBJ_CLSINIT,READER_CLSINIT,LIST_FORMAT,NAME_A,NAME_C,NAME_R)
values (172000,'Vulnerable Marine Ecosystem','Vulnerable Marine Ecosystem','Vulnerable Marine Ecosystem',1,172000,1,'Data collections',null,172000,null,null,null,null);
...
values (280001,'VME fishery management area','','',24030,24030,0,'VME fishery management areas',null,24000,null,null,null,null);
...
Insert into REF_GEO_WATER_SYSTEM (CD_GEO_WATER_SYSTEM,CD_META,NAME_E,NAME_F,NAME_S,CODE,CD_AREA_META,SYSTEM_FLAG,GEO_SELECTION_FLAG,NAME_A,NAME_C,NAME_R) 
values (1008,26000,'VME Coding System',null,null,'vme',280001,1,1,null,null,null);




Insert into ref_water_area (CD_WATER_AREA,NAME,CD_UN_CODE,CD_WATER_AREA_TYPE,GRP_IND,AREA,CD_META,EXTERNAL_ID,MIN_LONG,MAX_LONG,MIN_LAT,MAX_LAT,AREA_SIZE,CD_ISO3_CODE) 
values (5067,'Fogo Seamounts 1',null,7,'D',null,280001,'VME_NAFO_1',null,null,null,null,null,null);
Insert into ref_water_area (CD_WATER_AREA,NAME,CD_UN_CODE,CD_WATER_AREA_TYPE,GRP_IND,AREA,CD_META,EXTERNAL_ID,MIN_LONG,MAX_LONG,MIN_LAT,MAX_LAT,AREA_SIZE,CD_ISO3_CODE) 
values (5068,'Fogo Seamounts 2',null,7,'D',null,280001,'VME_NAFO_2',null,null,null,null,null,null);
Insert into ref_water_area (CD_WATER_AREA,NAME,CD_UN_CODE,CD_WATER_AREA_TYPE,GRP_IND,AREA,CD_META,EXTERNAL_ID,MIN_LONG,MAX_LONG,MIN_LAT,MAX_LAT,AREA_SIZE,CD_ISO3_CODE) 
values (5069,'Newfoundland Seamounts',null,7,'D',null,280001,'VME_NAFO_5',null,null,null,null,null,null);
Insert into ref_water_area (CD_WATER_AREA,NAME,CD_UN_CODE,CD_WATER_AREA_TYPE,GRP_IND,AREA,CD_META,EXTERNAL_ID,MIN_LONG,MAX_LONG,MIN_LAT,MAX_LAT,AREA_SIZE,CD_ISO3_CODE) 
values (5070,' New England Seamounts',null,7,'D',null,280001,'VME_NAFO_6',null,null,null,null,null,null);
