-- Cleaning Tasks (as FIGIS_GIS) to perform after 1st tests in dev/qa and after an agreement on the VME GIS table/view names to be used
-- (After this, re-run the below view creation and metadata record insertion)
DROP VIEW FIGIS_GIS.VMEMEASURE;
DROP VIEW FIGIS_GIS.VMEMEASURE_TIME;
...
SELECT
  ...
  qout.REG_TYPE,
  qout.REG_NAME,
  SDO_GEOM.SDO_AREA(THE_GEOM, 0.001, 'unit=SQ_M') AS SURFACE
FROM
