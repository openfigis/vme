 ...
 * @since 5 May 2014
 */
@Singleton @IPRestrictedResource @BandwidthLimitedResource @Path("/token/encrypted") 
public class EncryptedTokenProducerServiceImpl extends LocalTokenProducerServiceImpl {
	/**
	 * Class constructor
	 */
	@Inject public EncryptedTokenProducerServiceImpl(EncryptedTokenProducer tokenProducer) throws NamingException {
		super(tokenProducer);
	}
}